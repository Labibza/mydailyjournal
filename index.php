...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#aboutme">Tentang Saya</a>
            </li>
            <li class="nav-item">
        ...
        <div class="d-sm-flex flex-sm-row-reverse align-items-center ">
          ...
          <div>
            ...
            <h4 class="lead display-6">
              Selamat datang di My Daily Journal
            </br>
              Berbagi artikel seputar kegiatan saya di UDINUS
            </h4>
            <h6>
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                  Rekayasa Perangkat Lunak<br />15.30-18.00 | H.4.6
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                  Kriptografi<br />15.30-18.00 | Kulino
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          ...
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.15339</h3>
            <h1 class="fw-bold">Muhammad Labib Zaenal Arofi</h1>
    ...
    <footer id="footer" class="text-center p-5">
      ...
      <div>Muhammad Labib Zaenal Arofi &copy; 2024</div>
    </footer>
    <!-- footer end -->
